...
public class usun1 extends JDialog {
	...
	public usun1() {
		...
		{
			JLabel lblZaznaczKlientwKtrych = new JLabel("Zaznacz klientów, których chcesz usunąć");
