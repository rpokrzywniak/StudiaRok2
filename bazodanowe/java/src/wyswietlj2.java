...
public class wyswietlj2 extends JDialog {
	 ...
	 */
	public wyswietlj2() {
		setTitle("WYŚWIETL ZAMÓWIENIE");
		setBounds(100, 100, 450, 300);
		
		String[] info = Okno.getInformacje();
		int[] ilosci = Okno.getIlosc();
		String[] nazwa = Okno.getNazwa();
		String[] data_zam = Okno.getData_zam();
		String[] pokaz = new String[nazwa.length];
		for(int i=0;i<nazwa.length;i++){
			pokaz[i] = info[i]+"    |    "+nazwa[i]+"    |    "+ilosci[i]+"    |    "+data_zam[i];
		}
		...
		{
			JLabel lblZaznaczKlientwKtrych = new JLabel("Zaznacz zamówienia, których chcesz wyświetlić");
