...
public class wyswietlj4 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			wyswietlj4 dialog = new wyswietlj4();
	 ...
	 */
	public wyswietlj4() {
		setTitle("WYŚWIETL KAWĘ");
		setBounds(100, 100, 450, 300);
		
		String[] pokaz = Okno.getNazwakawy();
		...
		{
			JLabel lblZaznaczKlientwKtrych = new JLabel("Zaznacz kawy, które chcesz wyświetlić");
